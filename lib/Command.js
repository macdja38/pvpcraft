 ...
 * @returns {*}
 */
function removeTrailingS(string) {
...
class Command {
   ...
   * @param {Object} i10010n internationalization function
   */
  constructor(command, commandNoS, prefix, args, options, flags, msg, perms, raven, i10010n) {
   ...
   */
  clone() {
    let newCommand = new Command(this.command, this.commandnos, this.prefix, this.args, this.options, this.flags, this.msg, this.perms, this.raven);
   ...
   * @param {Function} [options.i10010n] internationaliztion function
    ...
    if (error.response == null) {
      ...
      if (owner) {
        owner.user.getDMChannel().then(channel =>
          channel.createMessage(this.i10010n() `Hello, I've removed and denied the permissions configuration for channel ${
