...
module.exports = class config {
  ...
  write(options) {
    ...
    return global.r.table(this.table).insert((serverId) ? this.data[serverId] : this.data["*"], { conflict: (options.conflict) ? options.conflict : "update" }).run(this.con).catch(console.error);
  }
