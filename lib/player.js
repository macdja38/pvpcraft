...
module.exports = class player {
    ...
    prettyList(textLength) {
        ...
        text += "`" + 0 + ".` " + this.currentVideo.prettyPrint() + " votes " + this.currentVideo.votes + " added by " + utils.fullNameB(this.currentVideo.user) + "\n";
        for(var song in this.queue) {
            var line = "`" + (parseInt(song) + 1) + ".` " + this.queue[song].prettyPrint() + " votes " + this.queue[song].votes + " added by " + utils.fullNameB(this.queue[song].user) + "\n";
