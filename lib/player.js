...
class player extends EventEmitter {
  ...
  canInit() {
    return this.voice.permissionsOf(this.client.user.id).has("joinVoiceChannel");
  }
  ...
  playNext() {
    ...
    if (this.connection) {
      ...
      if (source.container === "webm" && encoding === "opus" || source.container === "ogg" && encoding === "opus") {
      ...
      process.nextTick(() => {
        try {
          ...
          if (this.raven) this.raven.captureError(error);
        }
      });
